...
This fork of WhisperX supports [Silero VAD](https://github.com/snakers4/silero-vad.git) instead of pyannote. It does work, and seems to perform better than pyannote, but I haven't tested it extensively.
